...
using Content.Client._Stalker_EN.Examine;
...
public sealed partial class ShopMenu : DefaultWindow
{
    ...
    private void AddListingGui(ListingData listing, bool sell = false)
    {
        ...
        if (listing.ProductEntity != null)
        {
            ...
            if ((proto.TryGetComponent<ArmorComponent>(out _, _componentFactory)  || proto.TryGetComponent<GunComponent>(out _, _componentFactory))  && !proto.TryGetComponent<ZoneArtifactComponent>(out _, _componentFactory))
            {
